		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "A fiori configaration",
									"targetURL": "#skybfrftproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"skybfrftproject1-display": {
								"semanticObject": "skybfrftproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=skybfr.ft.project1",
									"url": sap.ui.require.toUrl("skybfr/ft/project1")
								}
							}
						}
					}
